...
export default function Drives() {
    ...
    queryFn: async () => {
      ...
      if (searchQuery) {
        ...
        return data.filter(d =>
          (d.companies?.name || "").toLowerCase().includes(normalizedQuery) ||
          (d.role_offered || "").toLowerCase().includes(normalizedQuery)
  ...
  const handleEdit = async (drive: PlacementDrive) => {
    ...
    form.reset({
      ...
      eligible_batches: drive.eligible_batches || "4th Year",
                    ...
                    <TabsContent value="eligibility" className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
                      ...
                      <div className="bg-slate-50 p-6 rounded-3xl border border-slate-200 space-y-6 shadow-inner">
                        ...
                        <div className="grid gap-6 sm:grid-cols-3">
                          ...
                          <div className="space-y-2">
                            <Label className="text-[10px] font-bold uppercase text-slate-400 px-1">Eligible Year</Label>
                            <Controller
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center gap-2 text-sm text-muted-foreground/80">
                                ...
                                <span>Eligible Year: {formatEligibleYearLabel(drive.eligible_batches || "4th Year")}</span>
